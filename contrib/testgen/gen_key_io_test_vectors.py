...
bech32_templates = [
  ...
  ('lrn',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('lrn',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('lrn',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('lrn',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tlrn',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlrn',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlrn',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlrn',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tlrn',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlrn',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlrn',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlrn',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rlrn',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rlrn',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rlrn',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rlrn', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tlrn',   17, 32, Encoding.BECH32M, False, False, False),
  ('rlrn',  3,  1, Encoding.BECH32M, False, False, False),
  ('lrn',   15, 41, Encoding.BECH32M, False, False, False),
  ('tlrn',    0, 16, Encoding.BECH32,  False, False, False),
  ('rlrn',  0, 32, Encoding.BECH32,  True,  False, False),
  ('lrn',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tlrn',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rlrn',  0, 20, Encoding.BECH32,  False, False, True),
  ('lrn',    0, 20, Encoding.BECH32M, False, False, False),
  ('tlrn',    0, 32, Encoding.BECH32M, False, False, False),
  ('rlrn',  0, 20, Encoding.BECH32M, False, False, False),
  ('lrn',    1, 32, Encoding.BECH32,  False, False, False),
  ('tlrn',    2, 16, Encoding.BECH32,  False, False, False),
  ('rlrn', 16, 20, Encoding.BECH32,  False, False, False),
]
