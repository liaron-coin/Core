...
const char * const BITCOIN_CONF_FILENAME = "liaron.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Liaron";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Liaron";
#else
    // Unix-like
    return pathRet / ".liaron";
#endif
#endif
}
