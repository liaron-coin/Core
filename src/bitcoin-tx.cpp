...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " liaron-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  liaron-tx [options] <hex-tx> [commands]  Update hex-encoded liaron transaction\n" +
            "or:     liaron-tx [options] -create [commands]   Create hex-encoded liaron transaction\n" +
            "\n";
