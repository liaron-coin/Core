Contributing to Liaron Core
============================

The Liaron Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Liaron Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/liaron-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to liaron-qt
...
The following applies to code changes to the Liaron Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Liaron
Network Protocol consensus changes.

Whether a pull request is merged into Liaron Core rests with the project merge
...
Patches that change Liaron consensus rules are considerably more involved than
...
Where a patch set proposes to change the Liaron consensus, it must have been
...
The project leader is the release manager for each Liaron Core release.
