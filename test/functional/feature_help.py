...
"""Verify that starting liaron with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start liaron with -h for help text")
        ...
        self.log.info("Start liaron with -version for version information")
        ...
        self.log.info("Start liarond with -fakearg to make sure it does not start")
