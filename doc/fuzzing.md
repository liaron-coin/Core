# Fuzzing Liaron Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Liaron Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the Liaron Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Liaron Core more robust.
...
with certain assembly code from Liaron Core's code. See [developer notes on sanitizers](/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Liaron Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Liaron Core using [`afl-fuzz`](https://github.com/google/afl):
