# Support for Output Descriptors in Liaron Core

Since Liaron Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `lrn1...` for mainnet or `tlrn1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Liaron Core wallets, a convenience function `combo` is
